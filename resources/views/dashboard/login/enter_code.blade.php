                                ...
                                <div class="card-box-form">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control input" name="code" placeholder="Enter Code Number" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="submit" value="Change Password" class="form-control btn-fill">
                                        </div>
                                    </form>
                                </div>
                            </div>
