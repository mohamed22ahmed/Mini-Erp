            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">@lang('dashboard.administrator')</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                ...
                <div class="row">
                    ...
                    @endif
                            ...
                            <div align="left" style="margin-left: 15px"><h3>@lang('dashboard.discount_page')</h3></div>

                            <div align="right">
                                <button type="button" name="add" id="add_data" class="btn btn-success btn-xl mr-5">@lang('dashboard.add_discount')</button>
                            </div>
                            <br />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(document).on('click', '.delete', function(){
                    ...
                    {
                        $.ajax({
                            url:"{{route('discounts.removedata')}}",
                            mehtod:"get",
                            data:{id:id},
                            success:function(data)
                            {
