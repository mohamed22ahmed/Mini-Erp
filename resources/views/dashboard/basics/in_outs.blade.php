                ...
                <div class="row">
                    ...
                    @endif
                            <div style="margin-left: 15px">
                                    <h3>@lang('dashboard.in_out_page')</h3>
                                </div>
                                <div>
